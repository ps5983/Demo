...
public class PagingUtil {
    ...
    public PagingUtil(int currentPage, int totalCount, int pageSize, int pageCount) {
        ...
        if (currentPage > pageCount) {
            pageHtml.append("<li class='page-item'><a class='page-link' href='#' onclick='fn_search(" + (startPage - 1) + ")'>이전</a></li>");
        }
        ...
        for (int i = startPage; i <= endPage; i++) {
            ...
            if (currentPage == i) {
                pageHtml.append("<li class='page-item'><a class='page-link' href='#'>" + i + "</a></li>");
            } else {
                pageHtml.append(
                        "<li class='page-item'><a class='page-link' href='#' onclick='fn_search(" + i + ")'>" + i + "</a></li>");
            }
        }

        // 다음 생성
        if (totalPage - startPage >= pageCount) {
            pageHtml.append("<li class='page-item'><a class='page-link' href='#' onclick='fn_search(" + (endPage + 1) + ")'>다음</a></li>");
        }
