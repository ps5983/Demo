...
<tr>
<td width="15%">제목</td>
<td><input class="form-control" type="text" name="bo_title" value=""/> </td>
</tr>
<tr>
<td colspan="2"><textarea rows = "10" class="form-control" type="text" name="bo_content"></textarea> </td>
</tr>
<tr>
<td colspan="2">
<input class="btn btn-success" type="button" value="목록" onclick="location.href = 'boardList'"/>
<input class="btn btn-success" type="button" value="저장" onclick="fn_save()"/>
